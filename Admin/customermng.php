...
if(isset($_GET['delete'])){
    ...
    header('location:customermng.php');
}
?>
...
.user-display-table td {
    ...
    .user-display-table tr:nth-child(even) {
      background-color: rgba(255, 255, 255, 0.1);
    }

    .user-display-table tr:nth-child(odd) {
      background-color: rgba(0, 0, 0, 0.5);
    }

    .user-display-table a.btn {
      padding: 8px 15px;
      background-color: #fdae40;
      color: #202020;
      border-radius: 5px;
    ...
    .user-display-table a.btn:hover {
      background-color: #fff;
      color: #fdae40;
    }
    </style>
    ...
    <h2>Users List</h2>
      <table class="user-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="customermng.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> Delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
