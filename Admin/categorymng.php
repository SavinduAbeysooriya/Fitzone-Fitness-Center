...
if(isset($_POST['add_category'])){
   ...
   $category_image_folder = 'C:/xampp/htdocs/gym/Assets/'.$category_image;
...
if(isset($_GET['delete'])){
   ...
   header('location:categorymng.php');
};
...
<head>
    ...
    <title>Add Category - Fitzone Fitness Center</title>
...
.hero .logout-btn {
    ...
    .admin-category-form-container h3 {
      font-size: 1.8rem;
      text-align: center;
      margin-bottom: 20px;
      color: #fdae40;
    ...
    .admin-category-form-container .box {
      width: 100%;
      padding: 10px;
      margin: 10px 0;
      border-radius: 5px;
    ...
    .admin-category-form-container .btn {
      width: 100%;
      padding: 10px;
      background-color: #fdae40;
      color: #202020;
    ...
    .admin-category-form-container .btn:hover {
      background-color: #fff;
      color: #fdae40;
    }
...
.category-display-table td {
    ...
    .category-display-table tr:nth-child(even) {
      background-color: rgba(255, 255, 255, 0.1);
    }

    .category-display-table tr:nth-child(odd) {
      background-color: rgba(0, 0, 0, 0.5);
    }

    .category-display-table a.btn {
      padding: 8px 15px;
      background-color: #fdae40;
      color: #202020;
      border-radius: 5px;
    ...
    .category-display-table a.btn:hover {
      background-color: #fff;
      color: #fdae40;
    }
    </style>
   ...
   <div class="category-display">
      <table class="category-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="categorymng.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> Delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
