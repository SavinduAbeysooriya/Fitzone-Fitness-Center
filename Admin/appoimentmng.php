...
if(isset($_GET['delete'])){
    ...
    header('location:appoimentmng.php');
}
?>
...
<head>
    ...
    <title>Booking Details - Fitzone Fitness Center</title>
...
.booking-display-table td {
    ...
    .booking-display-table a.btn:hover {
      background-color: #fff;
      color: #fdae40;
    }
    </style>
    ...
    <h2>Appoinments List</h2>
      <table class="booking-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="appoimentmng.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> Delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
