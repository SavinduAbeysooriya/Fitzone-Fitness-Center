...
<head>
    ...
    <title>Events & Promotions-Fitzone Fitness center</title>
...
<header>
  ...
  <a href="javascript:history.back()" class="back-button">←</a>
    ...
    <section class="program-menu">
        <div class="container">
            <h2 class="text-center">EVENTS AND PROMOTIONS</h2>
        ...
        <?php
            ...
            echo "<p class='text-center'>No event or promotion available at the moment.</p>";
        }
        ?>
